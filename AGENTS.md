...
## Big picture
- This repo contains the SFTI Common API specifications for the OpenAPI v3.1 interface of the dedicated pension topic.
...
- The top-level YAML `pensionAPI.yaml` (at repo root) is generated by the SFTI redocly workflow triggered on pull request. These bundled artifacts are used by consumers. Avoid editing generated files directly.
